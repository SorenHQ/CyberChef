...
if (!fs.existsSync(dir)) {
  ...
  console.log(
    "Example> node --experimental-modules src/core/config/scripts/newOperation.js"
  );
  process.exit(1);
}
...
class ${moduleName} extends Operation {
    ...
    constructor() {
        ...
        this.infoURL = "${
          result.infoURL
        }"; // Usually a Wikipedia link. Remember to remove localisation (i.e. https://wikipedia.org/etc rather than https://en.wikipedia.org/etc)
