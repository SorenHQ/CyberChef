...
import { fromBase64, toBase64 } from "./lib/Base64.js";
import { fromHex } from "./lib/Hex.js";
import { fromDecimal } from "./lib/Decimal.js";
import { fromBinary } from "./lib/Binary.js";
import * as decoder from "util";
/**
...
class Utils {
  ...
  static strToUtf8ArrayBuffer(str) {
    ...
    const buffer = new decoder.TextDecoder("utf-8").encode(str);
  ...
  static byteArrayToUtf8(byteArray) {
    ...
    try {
      const str = new decoder.TextDecoder("utf-8", { fatal: true }).decode(
        byteArray
      );
